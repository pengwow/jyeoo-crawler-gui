...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.groupBox_3.setGeometry(QtCore.QRect(10, 160, 981, 541))
        self.groupBox_3.setObjectName("groupBox_3")
        self.layoutWidget = QtWidgets.QWidget(self.groupBox_3)
        self.layoutWidget.setGeometry(QtCore.QRect(20, 30, 941, 501))
        ...
        self.groupBox_2.setGeometry(QtCore.QRect(10, 720, 981, 311))
        ...
        self.layoutWidget1.setGeometry(QtCore.QRect(20, 30, 891, 145))
        self.layoutWidget1.setObjectName("layoutWidget1")
        self.gridLayout_2 = QtWidgets.QGridLayout(self.layoutWidget1)
        self.gridLayout_2.setContentsMargins(0, 0, 0, 0)
        self.gridLayout_2.setObjectName("gridLayout_2")
        self.lcdNumber_from = QtWidgets.QLCDNumber(self.layoutWidget1)
        self.lcdNumber_from.setDigitCount(6)
        self.lcdNumber_from.setObjectName("lcdNumber_from")
        self.gridLayout_2.addWidget(self.lcdNumber_from, 0, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.comboBox_from, 0, 2, 1, 1)
        ...
        self.groupBox_4.setGeometry(QtCore.QRect(1000, 10, 1021, 1021))
        self.groupBox_4.setObjectName("groupBox_4")
        self.tableWidget_dataInfo = QtWidgets.QTableWidget(self.groupBox_4)
        self.tableWidget_dataInfo.setGeometry(QtCore.QRect(20, 30, 981, 971))
        self.tableWidget_dataInfo.setObjectName("tableWidget_dataInfo")
        self.tableWidget_dataInfo.setColumnCount(0)
        self.tableWidget_dataInfo.setRowCount(0)
        ...
        self.menubar.setGeometry(QtCore.QRect(0, 0, 2041, 41))
        ...
        MainWindow.setTabOrder(self.pushButton_getAccount, self.pushButton_clear)
        MainWindow.setTabOrder(self.pushButton_clear, self.comboBox_level)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_clear.setText(_translate("MainWindow", "清理退出"))
        ...
        self.groupBox_4.setTitle(_translate("MainWindow", "数据表格"))
